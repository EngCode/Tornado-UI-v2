...
/*jslint es6 */
/*===> Glide.js | v3.2.4 | Author: Jędrzej Chałubek | Released under the MIT License <===*/
(function (global, factory) {
    ...
    var defaults = {
        ...
        keyboard: true,
        /* Stop running `perView` number of slides from the end. Works only with `slider` type */
        bound: false,
