...
document.addEventListener("DOMContentLoaded",function(){'use strict';var dropdownButton=getElements(".dropdown-btn");Array.from(dropdownButton).forEach(function(dropdownButton){var dropdownList=getNextSibling(dropdownButton,".dropdown-list");dropdownButton.addEventListener("click",function(event){event.preventDefault();dropdownButton.classList.toggle("active");dropdownList.classList.toggle("active")})})});
