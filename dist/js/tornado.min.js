...
jQuery(function ($) {
    ...
    $('.tooltip.tooltip-responsive,.tooltip-bottom.tooltip-responsive').each(function() {
        var topTip = $(this).offset().top,
            bottomTip = $(this).offset().top + $(this).outerHeight(true);
        if( topTip < 50) {
            $(this).css({
                'top':'100%',
                'bottom':'auto',
            });
        } else if (bottomTip < 50) {
            $(this).css({
                'bottom':'100%',
                'top':'auto',
            });
    ...
    $('.tooltip-start.tooltip-responsive,.tooltip-end.tooltip-responsive').each(function() {
        var leftTip = $(this).offset().left,
            rightTip = $(this).offset().left + $(this).outerWidth(true);
        if( leftTip < 50) {
            $(this).css({
                'left':'0',
                'right':'auto',
